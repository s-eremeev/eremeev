...
### В теперь уже далёком 1994 году я защитил дипломную работу, написанную (да-да!) на [BASIC](https://ru.wikipedia.org/wiki/Бейсик) с использованием [ДВК-3](https://ru.wikipedia.org/wiki/Диалоговый_вычислительный_комплекс#ДВК-3).  
