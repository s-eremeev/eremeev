...
FROM
 ...
 -- странная группировка, которой не должно быть
 --	full join
 --		(select c_REG as c_REG_6, mo_oid as mo_oid_6, mo_short_name as mo_short_name_6, sp_oid as sp_oid_6, sp_name as sp_name_6, mp_dolgnost as mp_dolgnost_6,
 --		mp_fio, c_stavka,
 --		sum(c_STAVKA) as STF_sum from t_MAIN
 --		group by c_REG, mo_oid, mo_short_name, sp_oid, sp_name, mp_dolgnost, mp_fio, c_stavka) as t_STF
